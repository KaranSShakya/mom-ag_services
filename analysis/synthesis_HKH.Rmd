...
**Important**: Here is why I cannot add **HKH** and **Others** in the Country box. The *collaboration* box is created by looking into the author's country. This means selecting the country from the **affiliation** column of your excel file. Now, even though the **Geog_unit** might show others, the authors address will always have a country. Since there is not **HKH** or **Others** in the authors address, I cannot include these two terms in the diagram. This goes back to the problem I highlighted earliers, that a Sankey diagram can only have one column with numbers. 
